    ...
    <section id="contact" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-center text-lg md:text-xl text-gray-700 dark:text-gray-300 mb-16 max-w-3xl mx-auto leading-relaxed">
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide">Email</p>
                ...
                <a
                  ...
                  className="flex items-center space-x-4 p-6 glass glass-hover rounded-xl border-2 border-white/20 hover:border-green-400/50 transition-all group"
                >
                  <div className="p-4 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl group-hover:scale-110 transition-transform shadow-lg">
                    <Mail className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide">Phone</p>
                ...
                <div className="flex items-center space-x-4 p-6 glass glass-hover rounded-xl border-2 border-white/20 hover:border-purple-400/50 dark:hover:border-yellow-400/50 transition-all group">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide">Location</p>
              ...
              <div className="pt-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-4 glass glass-hover rounded-xl shadow-lg hover:shadow-lg transition-all hover:scale-110 transform"
                  >
