...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'resumes' | 'documents' | 'profile' | 'projects' | 'experience' | 'skills'>('resumes');
  ...
  const loadData = async () => {
    try {
      if (activeTab === 'resumes') {
        ...
        // Load portfolio data for profile, projects, experience, skills
